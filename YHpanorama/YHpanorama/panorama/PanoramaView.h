 ...
 *
 * @param vector can be non-normalized
 */
 ...
 *
 * @param vector coordinate location from origin. Use with CGRectContainsPoint( [[UIScreen mainScreen] bounds], screenPoint )
 ...
 *
 * @param rect defined in image pixel coordinates
